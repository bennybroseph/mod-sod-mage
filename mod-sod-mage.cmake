# mod-sod-mage — build hook (included inline by modules/CMakeLists.txt).
#
...
if(BUILD_TESTING)
  set_property(GLOBAL APPEND PROPERTY ACORE_MODULE_TEST_SOURCES
    "${CMAKE_CURRENT_LIST_DIR}/tests/test_sod_mage_rules.cpp")
  set_property(GLOBAL APPEND PROPERTY ACORE_MODULE_TEST_INCLUDES
    "${CMAKE_CURRENT_LIST_DIR}/src")
  message(STATUS "mod-sod-mage: registered unit tests")
endif()
